...
unit_manager.add_unit(PlayerId.ONE, unit_const=BuildingInfo.MONASTERY.ID, x=center+12, y=center-5)
...
east_gate = unit_manager.add_unit(PlayerId.ONE, unit_const=BuildingInfo.GATE_EAST_TO_WEST.ID, x=center+wall_radius, y=center)
west_gate = unit_manager.add_unit(PlayerId.ONE, unit_const=BuildingInfo.GATE_EAST_TO_WEST.ID, x=center-wall_radius, y=center)
...
tower_positions = [
    ...
    (center-wall_radius//2, center-wall_radius), # N flank
    (center+wall_radius//2, center-wall_radius), # N flank
    (center-wall_radius//2, center+wall_radius), # S flank
    (center+wall_radius//2, center+wall_radius)  # S flank
]
...
# Villagers
for i in range(10):
    unit_manager.add_unit(PlayerId.ONE, unit_const=UnitInfo.VILLAGER_MALE.ID, x=center-5+i, y=center+10)
